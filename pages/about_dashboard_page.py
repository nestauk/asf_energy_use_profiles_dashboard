...
def about_dashboard_page():
    ...
    st.markdown("""
                ...
                At [Nesta](https://www.nesta.org.uk/), we analysed smart meter data to **understand energy consumption in GB households**. 
                To achieve this, we utilised the [Smart Energy Research Lab (SERL) dataset](http://doi.org/10.5255/UKDA-SN-8666-8), which offers half-hourly gas and electricity consumption data, along with household survey data, for over 13,000 representative GB households.
                
                From this sample, we selected approximately **6,000 households** with high-quality data spanning **July 2023 to June 2024**.
    ...
    st.markdown("""
                ...
                We hope this tool will be useful for researchers, policymakers, and anyone interested in understanding household energy consumption.

                You can:
                - find insights in our [report]()
                - read the methodology in the [appendix]()
                - read more about this [Nesta project](https://www.nesta.org.uk/project/using-smart-meters-to-identify-energy-use-profiles/)
